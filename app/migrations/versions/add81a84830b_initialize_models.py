...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('rending', 'in_progress', 'ended', name='racestatus'), nullable=False, index=True),
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(length=80), nullable=False),
    sa.Column('description', sqlmodel.sql.sqltypes.AutoString(length=512), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('pending', 'approved', 'rejected', name='raceparticipationstatus'), nullable=False, index=True),
    ...
    sa.Column('rider_id', sa.Integer(), nullable=False, index=True),
    sa.Column('race_id', sa.Integer(), nullable=False, index=True),
