...
CREATE SEQUENCE IF NOT EXISTS classificationaccesslimiter_test_seq START WITH 10001
...
ALTER TABLE classificationaccesslimiter MODIFY (id DEFAULT classificationaccesslimiter_test_seq.nextval)
