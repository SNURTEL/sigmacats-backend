CREATE SEQUENCE IF NOT EXISTS bike_seq START WITH 1
CREATE SEQUENCE IF NOT EXISTS classification_seq START WITH 1
CREATE SEQUENCE IF NOT EXISTS classificationaccesslimiter_seq START WITH 1
CREATE SEQUENCE IF NOT EXISTS race_seq START WITH 1
CREATE SEQUENCE IF NOT EXISTS racebonus_seq START WITH 1
CREATE SEQUENCE IF NOT EXISTS raceparticipation_seq START WITH 1
CREATE SEQUENCE IF NOT EXISTS season_seq START WITH 1
